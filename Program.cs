...
// Console.WriteLine($"}}\n\r\n\rTo sum values 'n' through 5, enter the value for 'n':");
...
//    {
//       throw new ArgumentOutOfRangeException("upperBound", "ArgumentOutOfRangeException: upperBound must be greater than lowerBound.");
//    }
//    int sum = 0;
//    int count = 0;
//    decimal average = 0;
